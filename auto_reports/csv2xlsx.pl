...
#    (m)'16 [06 Jun 2016] Copyright H.M.Brand 2007-2016
...
my %fmt = (
    ...
    rest => $wbk->add_format (align => "left", num_format=> '@'),
    wrap => $wbk->add_format (align => "left", text_wrap => 1, num_format=> '@'),
    );

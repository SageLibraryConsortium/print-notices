...
sed -e '1 i Weekly Circ Report for week starting on '$REPORT_DATE'|' -e '1 i \ |' -e '$d' $BASEDIR/$FOLDER/$ORG'_weekly_circ_stats2'.csv > $BASEDIR/$FOLDER/$ORG'_weekly_circ_stats'.csv

...
\o /home/opensrf/scripts/auto_reports/SAGE_weekly_circ_stats2.csv
\a
\f |
SELECT
 to_char(ac."xact_start", 'YYYY-MM-DD') AS "Day",
...
FROM
  ...
  WHERE
  date_trunc('WEEK'::text, ac."xact_start") = date_trunc('WEEK'::text, now() - '1 week'::INTERVAL)
